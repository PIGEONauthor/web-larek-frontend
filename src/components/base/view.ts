...
export type ViewElement = HTMLElement | View<any, any, any, any>;
...
export class View<
  ...
  protected element<T extends View<any, any, any, any>>(name: string, ClassType?: new (el: HTMLElement, name: string) => T): T {
  ...
  protected select<T extends View<any, any, any, any>>(name: string, selector?: string, ClassType?: new (el: HTMLElement, name: string) => T): T {
    if (!this.elements[name]) {
      const $el = this.ensure<HTMLElement>(selector);
      if (ClassType) {
        this.elements[name] = new ClassType($el, name);
      } else {
        this.elements[name] = new View<any, any, any, any>($el, name);
      }
    }
    return this.elements[name] as T;
  }
...
//   }
  ...
  public static factory<T extends View<any, any, any, any>>(this: new (el: unknown, name?: string) => T, el: unknown, data?: any, name?: string): T {
